...
# ACDS 19.1 670 win32 2020.06.12.16:31:56
# ----------------------------------------
...
# ----------------------------------------
# If pll_hdmi_clk is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_hdmi_clk"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/programs/intelfpga_lite/19.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_hdmi_clk.vo"
}
